globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/page-B0sF_yx_.js","assets/layout-segment-context-DCVQb5Mx.js"];
...
function getDraftSecret() {
	return "dc8f7bab-5eaa-430f-a036-713dc1fd7360";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "5476983f-3aec-43ae-8bb4-8d205e83aa87";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "5476983f-3aec-43ae-8bb4-8d205e83aa87") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "5476983f-3aec-43ae-8bb4-8d205e83aa87",
		rootBoundaryId
	});
}
/**
